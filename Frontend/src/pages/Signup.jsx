    ...
    <div className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <input
          type="email"
          placeholder="Email"
          className="w-full p-3 mb-4 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-400 outline-none focus:ring-2 focus:ring-blue-400 transition"
        ...
        <input
          ...
          className="w-full p-3 mb-5 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-400 outline-none focus:ring-2 focus:ring-purple-400 transition"
